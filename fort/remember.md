...
- **Working name: LONGBURN** (established 2026-08-03; repo `longburn`; GitHub org free at naming time; .io/.game/.space showed available via whois — registrar checkout still pending, human bead). Name may change; the fort's name is separate and chosen at the moot.
